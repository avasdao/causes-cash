<template>
    <main class="bg-white">
        ...
        <section class="px-4 max-w-5xl mx-auto">
            <div class="text-center">
                ...
                <div class="mt-5 max-w-2xl mx-auto">
                    ...
                    <button @click="installMainnet" class="m-3 p-5 bg-green-300 rounded-xl border-4 border-green-500">
                        Install SmartBCH (Mainnet)
                    </button>

                    <button @click="installTestnet" class="m-3 p-5 bg-green-300 rounded-xl border-4 border-green-500">
                        Install SmartBCH (Testnet)
                    </button>

                    <p class="text-medium text-gray-600">
                        Open / unlock MetaMask, then click one of the buttons above for a one-click installation.
                    </p>
                </div>
        ...
        <section class="hidden mt-20 bg-white pb-16 px-4 overflow-hidden sm:px-6 lg:px-8 lg:pb-24">
