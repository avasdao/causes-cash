<template>
    <main aria-labelledby="policies-heading" class="mt-24 bg-gray-50 border-t border-gray-200">
                ...
                <div class="text-center md:flex md:items-start md:text-left lg:block lg:text-center">
                    ...
                    <div class="mt-6 md:mt-0 md:ml-4 lg:mt-6 lg:ml-0">
                        <h3 class="text-sm font-semibold tracking-wide uppercase text-gray-900">
                            Automatic Pledge Returns
                        </h3>
                        <p class="mt-3 text-sm text-gray-500">
                            When your pledge period expires, your funds will be automatically returned to your wallet.
                        </p>
                    </div>
                </div>
