<template>
    <main>
        ...
        <h4 class="mt-0">{{yesterday}}'s payout was <span class="light-green--text">$1.99</span> <small>0.0132 BCH</small></h4>
        ...
        <v-btn block large color="info" class="mt-5" @click="showMore">
            More favorites...
        </v-btn>
    </main>
</template>
...
export default {
    ...
    methods: {
        ...
        showMore() {
            ...
            this.items = causes.slice(20, this.displayCount)
        },
